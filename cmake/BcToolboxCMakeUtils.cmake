...
function(bc_compute_full_version OUTPUT_VERSION)
	...
	if(GIT_EXECUTABLE)
		...
		if (NOT (GIT_DESCRIBE_VERSION MATCHES "^([0-9]+)[.]([0-9]+)[.]([0-9]+)(-alpha|-beta|-divus)?(-[0-9]+)?(-g[0-9a-f]+)?$"))
		...
		if (version_prerelease)
			...
			if (version_commit)
				string(APPEND full_version ".${version_commit}")
			endif()
			if (version_hash)
				string(APPEND full_version "+${version_hash}")
			endif()
		endif()
